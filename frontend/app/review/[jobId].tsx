...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 30, fontWeight: "900", color: "#000", letterSpacing: -1, marginTop: 12 },
  subtitle: { color: colors.textSecondary, fontWeight: "600" },
  starsRow: { flexDirection: "row", justifyContent: "center", gap: 6, marginTop: 16 },
  starBtn: { padding: 4 },
  ratingLabel: { textAlign: "center", fontWeight: "900", fontSize: 18, color: "#000" },
});
